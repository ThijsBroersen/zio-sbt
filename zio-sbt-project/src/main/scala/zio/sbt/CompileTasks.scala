...
object CompileTasks {
  ...
  import PlatformAssertions.Keys._
  ...
  val docs: Def.Initialize[Seq[(String, String)]] = Def.settingDyn {
    val contains2_12       = PlatformAssertions.contains2_12.value
    val contains2_13       = PlatformAssertions.contains2_13.value
    val contains3          = PlatformAssertions.contains3.value
    val containsJS         = PlatformAssertions.containsJS.value
    ...
    val containsJVM        = PlatformAssertions.containsJVM.value
    ...
    val containsNative     = PlatformAssertions.containsNative.value
